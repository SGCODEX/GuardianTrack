...
class Cargo:
    ...
    def __str__(self):
        """
        Returns a string representation of the Cargo object.
        Useful for printing.
        """
...
class Airport:
    ...
    def __init__(self, name="Example Airport"):
        ...
        Args:
            name (str, optional): The name of the airport.
                                Defaults to "Example Airport".
        """
        self.name = name
        self.cargo_list = []
    ...
    def identify_hazard(self, cargo):
        """
        Simulates hazard identification based on cargo type.
    ...
    def display_map(self):
        """
        Displays a simplified text-based map of the airport and
        cargo locations.
        """
